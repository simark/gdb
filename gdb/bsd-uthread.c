...
bsd_uthread_set_supply_uthread (struct gdbarch *gdbarch,
				void (*supply_uthread) (struct regcache *,
							int, CORE_ADDR))
{
  struct bsd_uthread_ops *ops = (struct bsd_uthread_ops *) gdbarch_data (gdbarch, bsd_uthread_data);
			     ...
			     struct regcache *regcache, int regnum)
{
  ...
  struct bsd_uthread_ops *uthread_ops = (struct bsd_uthread_ops *) gdbarch_data (gdbarch, bsd_uthread_data);
