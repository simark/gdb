                 ...
                 const char *filename)
{
  ...
  struct macro_source_file *f = (struct macro_source_file *) macro_alloc (sizeof (*f), t);
...
{
  struct macro_definition *d = (struct macro_definition *) macro_alloc (sizeof (*d), t);
  ...
  if (kind == macro_function_like)
    {
      ...
      d->argv = (const char * const*) macro_bcache (t, cached_argv, cached_argv_size);
    }
