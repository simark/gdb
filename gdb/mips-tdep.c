...
mips_insn16_frame_cache (struct frame_info *this_frame, void **this_cache)
{
  ...
  /* Analyze the function prologue.  */
  {
    ...
    mips16_scan_prologue (gdbarch, start_addr, pc, this_frame, (struct mips_frame_cache *) *this_cache);
  }
...
mips_micro_frame_cache (struct frame_info *this_frame, void **this_cache)
{
  ...
  /* Analyze the function prologue.  */
  {
    ...
    micromips_scan_prologue (gdbarch, start_addr, pc, this_frame, (struct mips_frame_cache *) *this_cache);
  }
...
mips_insn32_frame_cache (struct frame_info *this_frame, void **this_cache)
{
  ...
  /* Analyze the function prologue.  */
  {
    ...
    mips32_scan_prologue (gdbarch, start_addr, pc, this_frame, (struct mips_frame_cache *) *this_cache);
  }
...
{				/* Do values for FP (float) regs.  */
  ...
  raw_buffer = (gdb_byte *) alloca (2 * register_size (gdbarch,
					  mips_regnum (gdbarch)->fp0));
