			    ...
			    void *user_data, VEC(gdb_xml_value_s) *attributes)
{
  ...
  ULONGEST *lmp = (long unsigned int *) xml_find_attribute (attributes, "lm")->value;
  ULONGEST *l_addrp = (long unsigned int *) xml_find_attribute (attributes, "l_addr")->value;
  ULONGEST *l_ldp = (long unsigned int *) xml_find_attribute (attributes, "l_ld")->value;
...
{
  struct solib_svr4_ops *ops = (struct solib_svr4_ops *) gdbarch_data (gdbarch, solib_svr4_data);
...
{
  struct solib_svr4_ops *ops = (struct solib_svr4_ops *) gdbarch_data (target_gdbarch (), solib_svr4_data);
