...
{
  const struct memory_write_request *a_req = (const struct memory_write_request *) a;
  const struct memory_write_request *b_req = (const struct memory_write_request *) b;
...
{
  VEC(memory_write_request_s) **v = (struct VEC_memory_write_request_s **) p;
  struct memory_write_request *r;
  int i;
