...
{
  const struct btrace_frame_cache *cache = (const struct btrace_frame_cache *) arg;
...
{
  const struct btrace_frame_cache *cache1 = (const struct btrace_frame_cache *) arg1;
  const struct btrace_frame_cache *cache2 = (const struct btrace_frame_cache *) arg2;
