...
get_ada_tasks_pspace_data (struct program_space *pspace)
{
  ...
  data = (struct ada_tasks_pspace_data *) program_space_data (pspace, ada_tasks_pspace_data_handle);
  if (data == NULL)
    {
...
get_ada_tasks_inferior_data (struct inferior *inf)
{
  ...
  data = (struct ada_tasks_inferior_data *) inferior_data (inf, ada_tasks_inferior_data_handle);
  if (data == NULL)
    {
