...
initialize_low_arch (void)
{
  ...
  tdesc_amd64_linux_no_xml = (struct target_desc *) xmalloc (sizeof (struct target_desc));
  ...
  tdesc_i386_linux_no_xml = (struct target_desc *) xmalloc (sizeof (struct target_desc));
