...
{
  struct gdbscm_disasm_read_data *data = (struct gdbscm_disasm_read_data *) datap;
  struct disassemble_info *dinfo = data->dinfo;
  struct gdbscm_disasm_data *disasm_data = (struct gdbscm_disasm_data *) dinfo->application_data;
...
{
  struct gdbscm_disasm_data *data = (struct gdbscm_disasm_data *) info->application_data;
